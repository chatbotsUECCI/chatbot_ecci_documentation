...
<ol type="I">
    ...
    <ol type="I">
        <li><a>Posibles Dificultades</a></li>
        <ol type ="a">
            <li><a>Curva de Aprendizaje de Tecnologías</a></li>
            <li><a>IBM Cloud Lite</a></li>
        </ol>
...
<ol style="list-style:none">
    ...
    <li><a href="#imagen21">Imagen 21 </a></li>
    <li><a href="#imagen22">Imagen 22 </a></li>
    <li><a href="#imagen23">Imagen 23 </a></li>
    <li><a href="#imagen24">Imagen 24 </a></li>
    <li><a href="#imagen25">Imagen 25 Creación de Cuenta en MongoDB</a></li>
    <li><a href="#imagen26">Imagen 26 Inicio de Sesión en MongoDB</a></li>
    <li><a href="#imagen27">Imagen 27 Configuración de Clúster en MongoDB</a></li>
    <li><a href="#imagen28">Imagen 28 Información de Clúster en MongoDB</a></li>
    <li><a href="#imagen29">Imagen 29 Conexión a Base de Datos MongoDB</a></li>
    <li><a href="#imagen30">Imagen 30 Información de Usuarios en MongoDB</a></li>
    <li><a href="#imagen31">Imagen 31 Crear Base de Datos en MongoDB</a></li>
    <li><a href="#imagen32">Imagen 32 Lista de Colecciones en MongoDB</a></li>
    <li><a href="#imagen33">Imagen 33 Conexión a MongoDB en NodeJS</a></li>
    <li><a href="#imagen34">Imagen 34 Estructura de Archivos Backend</a></li>
    <li><a href="#imagen35">Imagen 35 Servicio de Conexión Whatsapp</a></li>
    <li><a href="#imagen36">Imagen 36 Guardar Sesión de Conversación</a></li>
    <li><a href="#imagen37">Imagen 37 Envío de Mensajes a 360 Dialog</a></li>
    <li><a href="#imagen38">Imagen 38 Direccionamiento de Conversación Según la Sección</a></li>
    <li><a href="#imagen39">Imagen 39 Conectar con Agente</a></li>
    <li><a href="#imagen40">Imagen 40 Guardar Mensajes no Comprendidos</a></li>
    <li><a href="#imagen41">Imagen 41 Servicio de Conexión Telegram</a></li>
    <li><a href="#imagen42">Imagen 42 Ejemplo de Endpoint de Consulta de Métricas</a></li>
    <li><a href="#imagen43">Imagen 43 Conexión Middleware con Frontend</a></li>
    <li><a href="#imagen44">Imagen 44 Página Principal Frontend</a></li>
    <li><a href="#imagen45">Imagen 45 Estructura de Archivos Frontend</a></li>
    <li><a href="#imagen46">Imagen 46 Creación de Servicio de Cloud Foundry 1</a></li>
    <li><a href="#imagen47">Imagen 47 Creación de Servicio de Cloud Foundry 2</a></li>
    <li><a href="#imagen48">Imagen 48 Descripción de Despliegue de Cloud Foundry en IBM Cloud</a></li>
    <li><a href="#imagen49">Imagen 49 Descripción de Instancia de Cloud Foundry en Ejecución</a></li>
    <li><a href="#imagen50">Imagen 50 Archivo de Configuración de Despliegue en Cloud Foundry</a></li>
</ol>
...
<ol style="margin-left:2rem" type="a">
    ...
    <div>
        ...
        <p id="imagen25" style="text-align:center;font-size:0.8rem"><i>Imagen 25 Creación de Cuenta en MongoDB</i></p>
    </div>
    <p>Ingresa con usuario y contraseña.</p>
    <div>
        <p style="text-align:center"><image
        src="./Img/InicioSesionMongo.png" alt="Inicio de Sesión MongoDB" align="center" width="600px">
        <p id="imagen26" style="text-align:center;font-size:0.8rem"><i>Imagen 26 Inicio de Sesión MongoDB</i></p>
    </div>
    ...
    <div>
        ...
        <p id="imagen27" style="text-align:center;font-size:0.8rem"><i>Imagen 27 Configuración de Clúster en MongoDB</i></p>
    </div>
    <div>
        <p style="text-align:center"><image
        src="./Img/InformacionClusterMongo.png" alt="Información de Clúster en MongoDB" align="center" width="700px">
        <p id="imagen28" style="text-align:center;font-size:0.8rem"><i>Imagen 28 Información de Clúster en MongoDB</i></p>
    </div>
    ...
    <div>
        ...
        <p id="imagen29" style="text-align:center;font-size:0.8rem"><i>Imagen 29 Conexión a Base de Datos MongoDB</i></p>
    </div>
    ...
    <div>
        ...
        <p id="imagen30" style="text-align:center;font-size:0.8rem"><i>Imagen 30 Información de Usuarios en MongoDB</i></p>
    </div>
    ...
    <div>
        ...
        <p id="imagen31" style="text-align:center;font-size:0.8rem"><i>Imagen 31 Crear Base de Datos MongoDB</i></p>
    </div>
    ...
    <div>
        ...
        <p id="imagen32" style="text-align:center;font-size:0.8rem"><i>Imagen 32 Lista de Colecciones en MongoDB</i></p>
    </div>
    ...
    <ul type="disc">
        ...
        <li><b>sandbox_dialog: </b>Almacena las llaves que enlazan los mensajes.</li>
        <li><b>satisfaction:</b> Registra las respuestas de satisfacción de los usuarios.</li>
        <li><b>sede:</b> Almacena las sedes desde las cuales escriben los usuarios.</li>
        ...
        <li><b>tickets:</b> Almacena toda la información de los tickets.</li>
        <li><b>unassignedTickets:</b> Guarda los tickets que no tienen un agente asignado.</li>
    ...
    <div>
        <p style="text-align:center"><image
        src="./Img/ConexionMogoyNode.png" alt="Conexión a MongoDB en NodeJS" align="center" width="700px">
        <p id="imagen33" style="text-align:center;font-size:0.8rem"><i>Imagen 33 Conexión a MongoDB en NodeJS</i></p>
    </div>
    ...
    <ol>
        ...
        <p>Para actualizar datos, se usa el comando findOneAndUpdate. Este comando, recibe dos parámetros: uno con la consulta para filtrar los documentos a modificar y otro con los elementos que se modificarán</p>
...
<ol style="margin-left:2rem" type="a">
    ...
    <p><i>git clone git@github.com:chatbotsONU-UECCI/chatbotECCI.git</i></p>
    ...
    <div>
        <p style="text-align:center"><image
        src="./Img/EstructuraArchivosBackend.png" alt="Estructura de Archivos Backend" align="center" width="200px">
        <p id="imagen34" style="text-align:center;font-size:0.8rem"><i>Imagen 34 Estructura de Archivos Backend</i></p>
    </div>
    ...
    <ul type="square">
        <li>Servicio recepción mensajes 360 Dialog. “/inbound”</li>
        <div>
        <p style="text-align:center"><image
        src="./Img/ServicioConexionWhatsapp.png" alt="Servicio de Conexión Whatsapp" align="center" width="700px">
        <p id="imagen35" style="text-align:center;font-size:0.8rem"><i>Imagen 35 Servicio de Conexión Whatsapp</i></p>
        </div>
    ...
    <div>
        ...
        <p id="imagen36" style="text-align:center;font-size:0.8rem"><i>Imagen 36 Guardar Sesión de Conversación</i></p>
    </div>
    ...
    <div>
        ...
        <p id="imagen37" style="text-align:center;font-size:0.8rem"><i>Imagen 37 Envío de Mensajes a 360 Dialog</i></p>
    </div>
    ...
    <div>
        ...
        <p id="imagen38" style="text-align:center;font-size:0.8rem"><i>Imagen 38 Direccionamiento de Conversación Según la Sección.</i></p>
    </div>
    ...
    <div>
        ...
        <p id="imagen39" style="text-align:center;font-size:0.8rem"><i>Imagen 39 Conectar con Agente.</i></p>
    </div>
    ...
    <div>
        ...
        <p id="imagen40" style="text-align:center;font-size:0.8rem"><i>Imagen 40 Guardar Mensajes no Comprendidos.</i></p>
    </div>
    ...
    <li>Servicio para la recepción de mensajes Telegram</li>
    <div>
        <p style="text-align:center"><image
        src="./Img/ServicioConexionTelegram.png" alt="Servicio de Conexión Telegram" align="center" width="700px">
        <p id="imagen41" style="text-align:center;font-size:0.8rem"><i>Imagen 41 Servicio de Conexión Telegram.</i></p>
    </div>
    ...
    <div>
        ...
        <p id="imagen42" style="text-align:center;font-size:0.8rem"><i>Imagen 42 Ejemplo de Endpoint de Consulta de Métricas.</i></p>
    </div>
    ...
    <ol>
    <li><b>/getcampus: </b>Endpoint de consultas por cada sede disponible.</li>
    ...
    <li><b>/getothermessages: </b>ndpoint de mensajes no comprendidos por el chatbot.</li>
    ...
    <li><b>/requestagents: </b>Endpoint para la consulta de agentes disponibles en la plataforma web.</li>
    ...
    <div>
        ...
        <p id="imagen43" style="text-align:center;font-size:0.8rem"><i>Imagen 43 Conexión Middleware con Frontend.</i></p>
    </div>
    </ul>
</ol>
<h5 id="reactjs"></h5>
...
<div>
    ...
    <p id="imagen44" style="text-align:center;font-size:0.8rem"><i>Imagen 44 Página Principal Frontend.</i></p>
</div>
...
<div>
    ...
    <p id="imagen45" style="text-align:center;font-size:0.8rem"><i>Imagen 45 Estructura de Archivos Frontend.</i></p>
</div>
...
<div>
    ...
    <p id="imagen46" style="text-align:center;font-size:0.8rem"><i>Imagen 46 Creación de Servicio de Cloud Foundry 1.</i></p>
</div>
<div>
    <p style="text-align:center"><image
    src="./Img/CreacionServicioCloud2.png" alt="Creación de Servicio de Cloud Foundry 2" align="center" width="700px">
    <p id="imagen47" style="text-align:center;font-size:0.8rem"><i>Imagen 47 Creación de Servicio de Cloud Foundry 2.</i></p>
</div>
...
<div>
    ...
    <p id="imagen48" style="text-align:center;font-size:0.8rem"><i>Imagen 48 Descripción de Despliegue de Cloud Foundry en IBM Cloud.</i></p>
</div>
<div>
    <p style="text-align:center"><image
    src="./Img/DescripcionInstanciaCloud.png" alt="Descripción de Instancia de Cloud Foundry 
    en Ejecución" align="center" width="700px">
    <p id="imagen49" style="text-align:center;font-size:0.8rem"><i>Imagen 49 Descripción de Instancia de Cloud Foundry 
    en Ejecución.</i></p>
</div>
...
<div>
    ...
    <p id="imagen50" style="text-align:center;font-size:0.8rem"><i>Imagen 50 Archivo de Configuración de Despliegue en Cloud Foundry.</i></p>
</div>
